                  ...
                  <div className="flex flex-row">
                    ...
                    <div className="p-3 text-white grow flex flex-col justify-around w-full">
                      ...
                      <div className="flex flex-row text-center">
                        <div className="m-1 p-1 w-1/2 bg-blue-600 rounded-lg cursor-pointer hover:bg-blue-700" onClick={() => window.open("https://explorer.solana.com/address/" + nft.mint, "_blank")}>View</div>
